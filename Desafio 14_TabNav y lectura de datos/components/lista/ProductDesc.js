...
const ProductDesc = ({route,navigation}) =>{
    ...
    const checkFavProduct = () =>{
        ...
        data.forEach(element =>{
            if(element.productId == route.params.item.productId)
                setFav(true)
        })
    } 
             ...
             <View style={estilos.contenedorPrincipal}>
                    <View style={estilos.contenedorDetalle}>
                        ...
                        <View style={estilos.contenedorTitle}>
                            <Text style={estilos.itemTitle}>{route.params.item.productName}</Text>
                       ...
                       <View style={estilos.contenedorDetalleProducto}>
                           <View style={estilos.favoritos}>
                                <Text style={estilos.itemPrice}>{route.params.item.productPrice}</Text>
                                {fav
                                    ? <Icon name="heart" color="red" size={35} onPress={()=>DltfavProduct(route.params.item.productId)}/>
                            ...
                            <Text style={estilos.detalle}>{route.params.item.productDetail}</Text>
                       </View>
